...
public interface RegistrarApi {
    ...
    @ApiOperation(value = "Registro de ofertas", nickname = "registrarPost", notes = "Registro de ofertas (administradores)", response = JsonApiBodyResponseSuccess.class, tags={ "ofertas", })
    @ApiResponses(value = { 
