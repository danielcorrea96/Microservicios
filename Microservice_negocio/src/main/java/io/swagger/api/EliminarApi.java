...
public interface EliminarApi {
    ...
    ResponseEntity<JsonApiBodyResponseSuccess> eliminarIdNegocioDelete(@ApiParam(value = "Eliminar por ID de negocio.",required=true) @PathVariable("id_negocio") String idNegocio);
