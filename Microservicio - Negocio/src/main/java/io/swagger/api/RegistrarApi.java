...
public interface RegistrarApi {
    ...
    @ApiOperation(value = "Registro de negocios", nickname = "registrarPost", notes = "Registro de negocios (administradores)", response = JsonApiBodyResponseSuccess.class, tags={ "negocios", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Negocios registrado correctamente.", response = JsonApiBodyResponseSuccess.class),
