...
public interface EditarApi {
    ...
    @ApiOperation(value = "Editar persona", nickname = "editarPut", notes = "Editar persona por id", response = JsonApiBodyResponseSuccess.class, tags={ "personas", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Persona editada", response = JsonApiBodyResponseSuccess.class),
