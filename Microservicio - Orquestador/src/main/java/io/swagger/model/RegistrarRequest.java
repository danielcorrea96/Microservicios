...
import io.swagger.model.DatosNegocio;
...
public class RegistrarRequest   {
  ...
  public RegistrarRequest token(String token) {
	  ...
	  **/
	  ...
	  public RegistrarRequest adminKey(String adminKey) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, registrarRequest.id) &&
        ...
        Objects.equals(this.adminKey, registrarRequest.adminKey);
      
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, nombre, apellidos, correo, contrasena, telefono, genero, rol, estado, token, adminKey );
  }
